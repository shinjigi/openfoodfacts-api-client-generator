...
import type { ProductMetaSource1 } from './ProductMetaSource1';
import {
    ProductMetaSource1FromJSON,
    ProductMetaSource1FromJSONTyped,
    ProductMetaSource1ToJSON,
} from './ProductMetaSource1';
...
import type { ProductExtendedOwnerFields1 } from './ProductExtendedOwnerFields1';
import {
    ProductExtendedOwnerFields1FromJSON,
    ProductExtendedOwnerFields1FromJSONTyped,
    ProductExtendedOwnerFields1ToJSON,
} from './ProductExtendedOwnerFields1';
...
import type { EcoscoreData1 } from './EcoscoreData1';
import {
    EcoscoreData1FromJSON,
    EcoscoreData1FromJSONTyped,
    EcoscoreData1ToJSON,
} from './EcoscoreData1';
import type { ProductSelectedImages1 } from './ProductSelectedImages1';
import {
    ProductSelectedImages1FromJSON,
    ProductSelectedImages1FromJSONTyped,
    ProductSelectedImages1ToJSON,
} from './ProductSelectedImages1';
...
export interface Product {
    ...
    /**
     * 
     * @type {ProductSelectedImages1}
     * @memberof Product
     */
    selectedImages?: ProductSelectedImages1;
    /**
     * 
     * @type {EcoscoreData1}
     * @memberof Product
     */
    ecoscoreData?: EcoscoreData1;
    /**
     * 
     * @type {string}
     * @memberof Product
     ...
     * @memberof Product
     */
    nutritionDataPer?: ProductNutritionDataPerEnum;
    /**
     ...
     * @memberof Product
     */
    nutritionDataPreparedPer?: ProductNutritionDataPreparedPerEnum;
    /**
     * 
     ...
     * @memberof Product
     */
    nutriscoreGrade?: ProductNutriscoreGradeEnum;
    /**
    ...
    /**
     * 
     * @type {ProductExtendedOwnerFields1}
     * @memberof Product
     */
    ownerFields?: ProductExtendedOwnerFields1;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<ProductMetaSource1>}
     * @memberof Product
     */
    sources?: Array<ProductMetaSource1>;
    /**
     * 
...
export type ProductNutritionDataPerEnum = typeof ProductNutritionDataPerEnum[keyof typeof ProductNutritionDataPerEnum];
...
export type ProductNutritionDataPreparedPerEnum = typeof ProductNutritionDataPreparedPerEnum[keyof typeof ProductNutritionDataPreparedPerEnum];
...
export type ProductNutriscoreGradeEnum = typeof ProductNutriscoreGradeEnum[keyof typeof ProductNutriscoreGradeEnum];
...
export function ProductFromJSONTyped(json: any, ignoreDiscriminator: boolean): Product {
    ...
    return {
        ...
        'selectedImages': json['selected_images'] == null ? undefined : ProductSelectedImages1FromJSON(json['selected_images']),
        'ecoscoreData': json['ecoscore_data'] == null ? undefined : EcoscoreData1FromJSON(json['ecoscore_data']),
        ...
        'ownerFields': json['owner_fields'] == null ? undefined : ProductExtendedOwnerFields1FromJSON(json['owner_fields']),
        ...
        'sources': json['sources'] == null ? undefined : ((json['sources'] as Array<any>).map(ProductMetaSource1FromJSON)),
...
export function ProductToJSON(value?: Product | null): any {
    ...
    return {
        ...
        'selected_images': ProductSelectedImages1ToJSON(value['selectedImages']),
        'ecoscore_data': EcoscoreData1ToJSON(value['ecoscoreData']),
        ...
        'owner_fields': ProductExtendedOwnerFields1ToJSON(value['ownerFields']),
        ...
        'rev': value['rev'],
        'sources': value['sources'] == null ? undefined : ((value['sources'] as Array<any>).map(ProductMetaSource1ToJSON)),
