...
export function ImageElementFromJSONTyped(json: any, ignoreDiscriminator: boolean): ImageElement {
    if (json == null) {
        return json;
    }
    return {
...
export function ImageElementToJSON(value?: ImageElement | null): any {
    if (value == null) {
        return value;
    }
    return {
