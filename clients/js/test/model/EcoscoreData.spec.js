...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFoodFactsOpenApi.EcoscoreData();
  });
  ...
  describe('EcoscoreData', function() {
    it('should create an instance of EcoscoreData', function() {
      // uncomment below and update the code to test EcoscoreData
      var instance = new OpenFoodFactsOpenApi.EcoscoreData();
      expect(instance).to.be.a(OpenFoodFactsOpenApi.EcoscoreData);
    });
    ...
    it('should have the property missingDataWarning (base name: "missing_data_warning")', function() {
      // uncomment below and update the code to test the property missingDataWarning
      var instance = new OpenFoodFactsOpenApi.EcoscoreData();
      //expect(instance).to.be();
    });

    it('should have the property previousData (base name: "previous_data")', function() {
