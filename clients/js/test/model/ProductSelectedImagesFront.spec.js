...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFoodFactsOpenApi.ProductSelectedImagesFront();
  });
  ...
  describe('ProductSelectedImagesFront', function() {
    it('should create an instance of ProductSelectedImagesFront', function() {
      // uncomment below and update the code to test ProductSelectedImagesFront
      var instance = new OpenFoodFactsOpenApi.ProductSelectedImagesFront();
      expect(instance).to.be.a(OpenFoodFactsOpenApi.ProductSelectedImagesFront);
    });
