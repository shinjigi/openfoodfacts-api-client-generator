...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFoodFactsOpenApi.EcoscoreDataMissing();
  });
  ...
  describe('EcoscoreDataMissing', function() {
    it('should create an instance of EcoscoreDataMissing', function() {
      // uncomment below and update the code to test EcoscoreDataMissing
      var instance = new OpenFoodFactsOpenApi.EcoscoreDataMissing();
      expect(instance).to.be.a(OpenFoodFactsOpenApi.EcoscoreDataMissing);
    });
