...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFoodFactsOpenApi.ProductMetaSourceFieldsOrgGs();
  });
  ...
  describe('ProductMetaSourceFieldsOrgGs', function() {
    it('should create an instance of ProductMetaSourceFieldsOrgGs', function() {
      // uncomment below and update the code to test ProductMetaSourceFieldsOrgGs
      //var instance = new OpenFoodFactsOpenApi.ProductMetaSourceFieldsOrgGs();
      //expect(instance).to.be.a(OpenFoodFactsOpenApi.ProductMetaSourceFieldsOrgGs);
    });
