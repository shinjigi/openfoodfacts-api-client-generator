...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFoodFactsOpenApi.ProductEcoscoreAdjustments1OriginsOfIngredients();
  });
  ...
  describe('ProductEcoscoreAdjustments1OriginsOfIngredients', function() {
    it('should create an instance of ProductEcoscoreAdjustments1OriginsOfIngredients', function() {
      // uncomment below and update the code to test ProductEcoscoreAdjustments1OriginsOfIngredients
      //var instance = new OpenFoodFactsOpenApi.ProductEcoscoreAdjustments1OriginsOfIngredients();
      //expect(instance).to.be.a(OpenFoodFactsOpenApi.ProductEcoscoreAdjustments1OriginsOfIngredients);
    });
