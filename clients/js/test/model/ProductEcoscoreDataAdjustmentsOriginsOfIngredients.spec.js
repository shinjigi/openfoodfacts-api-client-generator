...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFoodFactsOpenApi.ProductEcoscoreDataAdjustmentsOriginsOfIngredients();
  });
  ...
  describe('ProductEcoscoreDataAdjustmentsOriginsOfIngredients', function() {
    it('should create an instance of ProductEcoscoreDataAdjustmentsOriginsOfIngredients', function() {
      // uncomment below and update the code to test ProductEcoscoreDataAdjustmentsOriginsOfIngredients
      //var instance = new OpenFoodFactsOpenApi.ProductEcoscoreDataAdjustmentsOriginsOfIngredients();
      //expect(instance).to.be.a(OpenFoodFactsOpenApi.ProductEcoscoreDataAdjustmentsOriginsOfIngredients);
    });
