...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFoodFactsOpenApi.SelectedImage();
  });
  ...
  describe('SelectedImage', function() {
    it('should create an instance of SelectedImage', function() {
      // uncomment below and update the code to test SelectedImage
      //var instance = new OpenFoodFactsOpenApi.SelectedImage();
      //expect(instance).to.be.a(OpenFoodFactsOpenApi.SelectedImage);
    });
