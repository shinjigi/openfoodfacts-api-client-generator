...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFoodFactsOpenApi.UnselectAPhotoResponse();
  });
  ...
  describe('UnselectAPhotoResponse', function() {
    it('should create an instance of UnselectAPhotoResponse', function() {
      // uncomment below and update the code to test UnselectAPhotoResponse
      //var instance = new OpenFoodFactsOpenApi.UnselectAPhotoResponse();
      //expect(instance).to.be.a(OpenFoodFactsOpenApi.UnselectAPhotoResponse);
    });
