...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFoodFactsOpenApi.ProductSelectedImagesIngredients();
  });
  ...
  describe('ProductSelectedImagesIngredients', function() {
    it('should create an instance of ProductSelectedImagesIngredients', function() {
      // uncomment below and update the code to test ProductSelectedImagesIngredients
      //var instance = new OpenFoodFactsOpenApi.ProductSelectedImagesIngredients();
      //expect(instance).to.be.a(OpenFoodFactsOpenApi.ProductSelectedImagesIngredients);
    });
