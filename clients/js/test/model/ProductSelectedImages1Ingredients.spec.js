...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFoodFactsOpenApi.ProductSelectedImages1Ingredients();
  });
  ...
  describe('ProductSelectedImages1Ingredients', function() {
    it('should create an instance of ProductSelectedImages1Ingredients', function() {
      // uncomment below and update the code to test ProductSelectedImages1Ingredients
      //var instance = new OpenFoodFactsOpenApi.ProductSelectedImages1Ingredients();
      //expect(instance).to.be.a(OpenFoodFactsOpenApi.ProductSelectedImages1Ingredients);
    });
