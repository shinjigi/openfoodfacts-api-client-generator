...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFoodFactsOpenApi.ImageRoleSizes();
  });
  ...
  describe('ImageRoleSizes', function() {
    it('should create an instance of ImageRoleSizes', function() {
      // uncomment below and update the code to test ImageRoleSizes
      //var instance = new OpenFoodFactsOpenApi.ImageRoleSizes();
      //expect(instance).to.be.a(OpenFoodFactsOpenApi.ImageRoleSizes);
    });
