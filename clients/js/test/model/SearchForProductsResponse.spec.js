...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFoodFactsOpenApi.SearchForProductsResponse();
  });
  ...
  describe('SearchForProductsResponse', function() {
    it('should create an instance of SearchForProductsResponse', function() {
      // uncomment below and update the code to test SearchForProductsResponse
      //var instance = new OpenFoodFactsOpenApi.SearchForProductsResponse();
      //expect(instance).to.be.a(OpenFoodFactsOpenApi.SearchForProductsResponse);
    });
