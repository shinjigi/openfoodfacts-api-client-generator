...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFoodFactsOpenApi.AttributeGroup();
  });
  ...
  describe('AttributeGroup', function() {
    it('should create an instance of AttributeGroup', function() {
      ...
      //var instance = new OpenFoodFactsOpenApi.AttributeGroup();
      //expect(instance).to.be.a(OpenFoodFactsOpenApi.AttributeGroup);
    });
