...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenFoodFactsOpenApi.AdjustmentsOriginOfIngredientAggregated();
  });
  ...
  describe('AdjustmentsOriginOfIngredientAggregated', function() {
    it('should create an instance of AdjustmentsOriginOfIngredientAggregated', function() {
      // uncomment below and update the code to test AdjustmentsOriginOfIngredientAggregated
      //var instance = new OpenFoodFactsOpenApi.AdjustmentsOriginOfIngredientAggregated();
      //expect(instance).to.be.a(OpenFoodFactsOpenApi.AdjustmentsOriginOfIngredientAggregated);
    });
