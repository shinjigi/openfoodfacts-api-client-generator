 ...
 * Search products with filters (GET)
 */
export const searchV1ProductsGet = <ThrowOnError extends boolean = false>(options?: Options<SearchV1ProductsGetData, ThrowOnError>) => {
    return (options?.client ?? client).get<SearchV1ProductsGetResponse, SearchV1ProductsGetError, ThrowOnError>({
        ...options,
        url: '/cgi/search.pl'
    });
};
 ...
 * Search products with filters (POST)
 */
export const searchV1ProductsPost = <ThrowOnError extends boolean = false>(options: Options<SearchV1ProductsPostData, ThrowOnError>) => {
    return (options?.client ?? client).post<SearchV1ProductsPostResponse, SearchV1ProductsPostError, ThrowOnError>({
        ...options,
        ...formDataBodySerializer,
        headers: {
            'Content-Type': null,
