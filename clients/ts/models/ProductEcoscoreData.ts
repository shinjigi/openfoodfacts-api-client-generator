...
*/
export class ProductEcoscoreData {
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "ecoscore_not_applicable_for_category",
            "baseName": "ecoscore_not_applicable_for_category",
            "type": "string",
            "format": ""
        },
        {
    ...
    static getAttributeTypeMap() {
        return ProductEcoscoreData.attributeTypeMap;
    }
