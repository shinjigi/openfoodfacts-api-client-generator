...
export const server1 = new ServerConfiguration<{  }>("https://world.openfoodfacts.net", {  })
export const server2 = new ServerConfiguration<{  }>("https://world.openfoodfacts.org", {  })
export const server3 = new ServerConfiguration<{  }>("http://localhost:8080", {  })
