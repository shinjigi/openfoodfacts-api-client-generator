...
export class DefaultApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async cgiProductImageUnselectPlPost(code?: string, id?: string, _options?: Configuration): Promise<RequestContext> {
...
export class DefaultApiResponseProcessor {
     ...
     *
     * @params response Response returned by the server for a request to cgiProductImageUnselectPlPost
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async cgiProductImageUnselectPlPostWithHttpInfo(response: ResponseContext): Promise<HttpInfo<UnselectAPhotoResponse >> {
