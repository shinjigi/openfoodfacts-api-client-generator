 ...
 */
export function instanceOfProductAttributeGroups(
  value: object,
): value is ProductAttributeGroups {
  return true;
}

export function ProductAttributeGroupsFromJSON(
  json: any,
): ProductAttributeGroups {
  return ProductAttributeGroupsFromJSONTyped(json, false);
}

export function ProductAttributeGroupsFromJSONTyped(
  json: any,
...
export function ProductAttributeGroupsToJSON(
  json: any,
): ProductAttributeGroups {
  return ProductAttributeGroupsToJSONTyped(json, false);
}

export function ProductAttributeGroupsToJSONTyped(
  value?: ProductAttributeGroups | null,
