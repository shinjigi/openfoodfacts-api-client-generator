...
export function TableElementFromJSONTyped(
  json: any,
...
export function TableElementToJSON(json: any): TableElement {
  return TableElementToJSONTyped(json, false);
}

export function TableElementToJSONTyped(
  value?: TableElement | null,
