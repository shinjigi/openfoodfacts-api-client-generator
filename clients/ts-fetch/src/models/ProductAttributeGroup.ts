...
export type ProductAttributeGroupStatusEnum =
  (typeof ProductAttributeGroupStatusEnum)[keyof typeof ProductAttributeGroupStatusEnum];
...
export type ProductAttributeGroupGradeEnum =
  (typeof ProductAttributeGroupGradeEnum)[keyof typeof ProductAttributeGroupGradeEnum];

/**
 * Check if a given object implements the ProductAttributeGroup interface.
 */
export function instanceOfProductAttributeGroup(
  value: object,
): value is ProductAttributeGroup {
  return true;
}

export function ProductAttributeGroupFromJSON(
  json: any,
): ProductAttributeGroup {
  return ProductAttributeGroupFromJSONTyped(json, false);
}

export function ProductAttributeGroupFromJSONTyped(
  json: any,
  ...
  return {
    ...
    description_short:
      json["description_short"] == null ? undefined : json["description_short"],
  };
}

export function ProductAttributeGroupToJSON(json: any): ProductAttributeGroup {
  return ProductAttributeGroupToJSONTyped(json, false);
}

export function ProductAttributeGroupToJSONTyped(
  value?: ProductAttributeGroup | null,
