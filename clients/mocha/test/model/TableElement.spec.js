...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new OpenFoodFactsOpenApi.TableElement();
  });
  ...
  describe('TableElement', function () {
    it('should create an instance of TableElement', function () {
      // uncomment below and update the code to test TableElement
      var instance = new OpenFoodFactsOpenApi.TableElement();
      expect(instance).to.be.a(OpenFoodFactsOpenApi.TableElement);
    });
