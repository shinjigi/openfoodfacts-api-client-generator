...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new OpenFoodFactsOpenApi.ProductImages();
  });
  ...
  describe('ProductImages', function () {
    it('should create an instance of ProductImages', function () {
      ...
      var instance = new OpenFoodFactsOpenApi.ProductImages();
      expect(instance).to.be.a(OpenFoodFactsOpenApi.ProductImages);
    });
