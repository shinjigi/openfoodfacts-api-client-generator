...
(function (root, factory) {
  ...
  beforeEach(function () {
    instance = new OpenFoodFactsOpenApi.Panels();
  });
  ...
  describe('Panels', function () {
    it('should create an instance of Panels', function () {
      // uncomment below and update the code to test Panels
      var instance = new OpenFoodFactsOpenApi.Panels();
      expect(instance).to.be.a(OpenFoodFactsOpenApi.Panels);
    });
